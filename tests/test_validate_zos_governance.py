...
def test_validate_governance_allows_zos_change_exception_id(tmp_path: Path) -> None:
    governance_dir = tmp_path / "docs" / "governance"
    governance_dir.mkdir(parents=True)
    ...
    _write(
        governance_dir / "ZOS-CHANGE-0001.md",
        _base_doc(
            "ZOS-CHANGE-0001",
            "ZOS Governance Change Log",
            "Active",
            deps="ZOS-CON-0001; ZOS-STD-0001",
            planned="None",
        ),
    )
    _write(
